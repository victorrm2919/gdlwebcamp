(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    let paseDosDias = document.getElementById('pase-dosDias');
    ...
    let listaProductos = document.getElementById('lista-producto');
    let total = document.getElementById('suma-total');

    //Dias evento
    let viernes = document.getElementById('viernes');
    let sabado = document.getElementById('sábado');
    ...
    function mostrarDias() {
      if(scrollY == 0 ) {
        $('html, body').animate({
          scrollTop: $("#registroUsuario").offset().top
        }, 800);
      }
      let boletoDia = parseInt(paseDia.value) || 0,
        boletoDosDias = parseInt(paseDosDias.value) || 0,
