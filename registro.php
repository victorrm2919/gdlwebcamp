...
<section class="seccion contenedor">
  ...
  <form action="#" id="registro" class="registro">
        ...
        <li>
          <div class="tabla-precio">
            ...
            <div class="orden">
              ...
              <input type="number" id="pase-dia" min="0" size="3" placeholder="0">
            </div>
          </div>
        </li>
        ...
        <li>
          <div class="tabla-precio">
            ...
            <div class="orden">
              ...
              <input type="number" id="pase-completo" min="0" size="3" placeholder="0">
            </div>
          </div>
        </li>
        ...
        <li>
          <div class="tabla-precio">
            ...
            <div class="orden">
              ...
              <input type="number" id="pase-dosDias" min="0" size="3" placeholder="0">
            </div>
          </div>
        </li>
    ...
    <div id="resumen" class="resumen">
      ...
      <div class="caja resumen-contenido">
        ...
        <div class="total">
          ...
          <input type="submit" class="btn" id="btnRegistro" value="Pagar">
