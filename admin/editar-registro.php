...
$id_registrado = $_GET['id'];

if (!filter_var($id_registrado, FILTER_VALIDATE_INT)) {
...
/* Validacion de info */
try {
  $info= $conn->query("SELECT * FROM registrados WHERE id_registrado = $id_registrado");
  $registro = $info->fetch_assoc();
} catch (Exception $e) {
  $error = $e->getMessage();
    ...
    <div class="col-xl-9 m-xl-auto m-3">
      ...
      <section class="content">
        ...
        <div class="card">
          ...
          <form class="form-horizontal text-center guardar-registro-usuario" name="guardar-registro" id="guardar-registro"
            ...
            <div class="card-body">
              <div class="validacion">
                <div class="form-group row justify-content-center">
                  ...
                  <div class="col-sm-9 col-md-6 input-group">
                    <input type="text" class="form-control" id="nombre" placeholder="Nombre del Registrado"
                      name="nombre" required autocomplete="off" value="<?php echo $registro['nombre_registrado']?>">
                  </div>
                </div>
                <div class="form-group row justify-content-center">
                  ...
                  <div class="col-sm-9 col-md-6 input-group">
                    <input type="text" class="form-control" id="apellido" placeholder="Apellido del Registrado"
                      name="apellido" required autocomplete="off" value="<?php echo $registro['apellido_registrado']?>">
                  </div>
                </div>
                <div class="form-group row justify-content-center">
                  ...
                  <div class="col-sm-9 col-md-6 input-group">
                    <input type="email" class="form-control" id="email" placeholder="Correo Electronico" name="email"
                      required autocomplete="off" value="<?php echo $registro['email_registrado']?>">
                  </div>
                </div>
              ...
              <?php 
              $pedido = json_decode($registro['pases_articulos'], true);
              $boleto_dia = (isset($pedido['un_dia'])) ? $pedido['un_dia'] : '';
              $boleto_completo = (isset($pedido['pase_completo'])) ? $pedido['pase_completo'] : '';
              $boleto_2dias = (isset($pedido['pase_2dias'])) ? $pedido['pase_2dias'] : '';
              ?>
                          ...
                          <div class="card-body d-flex flex-column justify-content-around">
                            ...
                            <div class="orden">
                              ...
                              <input type="number" id="pase-dia" name="boletos[un_dia][cantidad]" min="0" size="3"
                                placeholder="0" class="form-control text-center" value="<?php echo $boleto_dia?>">
                          ...
                          <div class="card-body d-flex flex-column justify-content-around">
                            ...
                            <div class="orden">
                              ...
                              <input type="number" id="pase-completo" name="boletos[completo][cantidad]" min="0"
                                ...
                                value="<?php echo $boleto_completo?>">
                          ...
                          <div class="card-body d-flex flex-column justify-content-around">
                            ...
                            <div class="orden">
                              ...
                              <input type="number" id="pase-dosDias" name="boletos[2dias][cantidad]" min="0" size="3"
                                placeholder="0" class="form-control text-center" value="<?php echo $boleto_2dias?>">
              ...
              <div class="form-group">
                <div id="eventos" class="eventos card elevation-2">
                  <div class="card-header">
                    ...
                    <button type="button" class="btn btn-primary btn-sm limpiar float-right">Limpiar Opciones</button>
                  </div>
                  <?php
                    try {
                          ...
                          <div class="m-2 ml-md-1 card card-body">
                            ...
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" name="registro_evento[]" id="<?php echo $valor['clave']?>"
                                ...
                                <?php 
                                /* validacion de checked */
                                $eventos = json_decode($registro['talleres_registrados'], true);
                                echo (in_array($valor['clave'], $eventos['eventos'])) ? 'checked' : '';
                ...
                <div id="resumen" class="resumen card elevation-2">
                  ...
                  <div class="caja resumen-contenido row card-body align-items-center">
                    <div class="extras col-md-6">
                      <div class="orden form-group row">
                        ...
                        <input type="number" min="0" id="camisa-evento" name="pedido_extra[camisas][cantidad]" size="3"
                          placeholder="0" class="form-control col-md-2 text-center" value="<?php echo $pedido['camisas']?>">
                      ...
                      <div class="orden form-group row">
                        ...
                        <input type="number" min="0" id="etiquetas" name="pedido_extra[etiquetas][cantidad]" size="3"
                          placeholder="0" class="form-control col-md-2 text-center" value="<?php echo $pedido['etiquetas']?>">
                      ...
                      <div class="orden">
                        <div class="form-group row">
                          ...
                          <select id="regalo" name="regalo" required class="form-control select col-md-9">
                            ...
                            <option value="<?php echo $regalo['id_regalo']?>" <?php  echo ($registro['regalo'] == $regalo['id_regalo'])? 'selected':''?>>
                    ...
                    <div class="total col-md-6 products-list">
                      <div class="total-pagado card card-body bg-gray-light col-5 mx-auto"> 
                        <p>Total pagado: <span>$<?php echo $registro['total_pagado']?></span></p>
                        <input id="pago_anterior" type="hidden" value="<?php echo $registro['total_pagado']?>">
                      </div>
            ...
            <div class="card-footer text-right">
              ...
              <input type="hidden" name="id_registro" value="<?php echo $registro['id_registrado'] ?>">
              <input type="hidden" name="fecha_registro" value="<?php echo $registro['fecha_registro'] ?>">
              <button type="submit" class="btn btn-primary" id="btn-enviar-registro-usuario">Actualizar</button>
            </div>
            <!-- /.card-footer -->
          </form>
        </div>
